          ...
          >
            <div className="box">
              <div className="flex items-start px-5 pt-5">
                ...
                <Menu className="absolute top-0 right-0 mt-3 mr-5">
                  ...
                  <Menu.Items className="w-40">
                    ...
                    <Menu.Item>
                      <Lucide icon="Trash" className="w-4 h-4 mr-2" /> Disable
                    </Menu.Item>
                  </Menu.Items>
                </Menu>
              </div>
              ...
              <div className="p-5 text-center border-t lg:text-right border-slate-200/60 dark:border-darkmode-400">
                <Button variant="outline-primary" className="px-2 py-1 mr-2">
                  Edit
                </Button>
                <Button variant="soft-danger" className="px-2 py-1 mr-2">
                  Disable
                </Button>
